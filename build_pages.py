...
NG_SVG = """<svg class="ngviz" viewBox="0 0 1200 500" preserveAspectRatio="xMidYMid slice" role="img" aria-label="Ambient animated node graph: a mesh of context, agent and model nodes with data flowing along the links"><line class="ngedge" x1="70" y1="120" x2="250" y2="80"/><line class="ngedge" x1="70" y1="120" x2="150" y2="300"/><line class="ngedge" x1="250" y1="80" x2="440" y2="150"/><line class="ngedge" x1="250" y1="80" x2="350" y2="250"/><line class="ngedge" x1="440" y1="150" x2="620" y2="90"/><line class="ngedge" x1="440" y1="150" x2="350" y2="250"/><line class="ngedge" x1="440" y1="150" x2="540" y2="330"/><line class="ngedge" x1="620" y1="90" x2="810" y2="150"/><line class="ngedge" x1="620" y1="90" x2="730" y2="260"/><line class="ngedge" x1="810" y1="150" x2="1000" y2="90"/><line class="ngedge" x1="810" y1="150" x2="730" y2="260"/><line class="ngedge" x1="810" y1="150" x2="930" y2="320"/><line class="ngedge" x1="1000" y1="90" x2="1150" y2="210"/><line class="ngedge" x1="1000" y1="90" x2="1030" y2="250"/><line class="ngedge" x1="1150" y1="210" x2="1110" y2="380"/><line class="ngedge" x1="1150" y1="210" x2="1030" y2="250"/><line class="ngedge" x1="150" y1="300" x2="350" y2="250"/><line class="ngedge" x1="150" y1="300" x2="90" y2="440"/><line class="ngedge" x1="150" y1="300" x2="250" y2="430"/><line class="ngedge" x1="350" y1="250" x2="540" y2="330"/><line class="ngedge" x1="350" y1="250" x2="440" y2="440"/><line class="ngedge" x1="350" y1="250" x2="250" y2="430"/><line class="ngedge" x1="540" y1="330" x2="730" y2="260"/><line class="ngedge" x1="540" y1="330" x2="440" y2="440"/><line class="ngedge" x1="540" y1="330" x2="660" y2="430"/><line class="ngedge" x1="730" y1="260" x2="930" y2="320"/><line class="ngedge" x1="730" y1="260" x2="660" y2="430"/><line class="ngedge" x1="730" y1="260" x2="860" y2="440"/><line class="ngedge" x1="930" y1="320" x2="1110" y2="380"/><line class="ngedge" x1="930" y1="320" x2="860" y2="440"/><line class="ngedge" x1="930" y1="320" x2="1030" y2="250"/><line class="ngedge" x1="1110" y1="380" x2="1030" y2="250"/><line class="ngedge" x1="90" y1="440" x2="250" y2="430"/><line class="ngedge" x1="440" y1="440" x2="660" y2="430"/><line class="ngedge" x1="440" y1="440" x2="250" y2="430"/><line class="ngedge" x1="660" y1="430" x2="860" y2="440"/><circle class="pkt" r="3.4"><animateMotion dur="2.6s" begin="0.0s" repeatCount="indefinite" path="M70,120 L250,80"/></circle><circle class="pkt ac" r="3.4"><animateMotion dur="2.8s" begin="0.4s" repeatCount="indefinite" path="M250,80 L350,250"/></circle><circle class="pkt" r="3.4"><animateMotion dur="3.0s" begin="0.8s" repeatCount="indefinite" path="M620,90 L810,150"/></circle><circle class="pkt ac" r="3.4"><animateMotion dur="3.2s" begin="1.2s" repeatCount="indefinite" path="M810,150 L930,320"/></circle><circle class="pkt" r="3.4"><animateMotion dur="3.4s" begin="1.6s" repeatCount="indefinite" path="M1150,210 L1110,380"/></circle><circle class="pkt ac" r="3.4"><animateMotion dur="2.6s" begin="2.0s" repeatCount="indefinite" path="M150,300 L250,430"/></circle><circle class="pkt" r="3.4"><animateMotion dur="2.8s" begin="2.4s" repeatCount="indefinite" path="M350,250 L250,430"/></circle><circle class="pkt ac" r="3.4"><animateMotion dur="3.0s" begin="2.8s" repeatCount="indefinite" path="M730,260 L930,320"/></circle><circle class="pkt" r="3.4"><animateMotion dur="3.2s" begin="3.2s" repeatCount="indefinite" path="M930,320 L1110,380"/></circle><circle class="pkt ac" r="3.4"><animateMotion dur="3.4s" begin="3.6s" repeatCount="indefinite" path="M440,440 L660,430"/></circle><circle class="ngdot" cx="70" cy="120" r="7" style="animation-delay:0.0s"/><circle class="ngdot" cx="250" cy="80" r="7" style="animation-delay:0.17s"/><circle class="ngdot ac" cx="440" cy="150" r="7" style="animation-delay:0.34s"/><circle class="ngdot hub" cx="620" cy="90" r="12" style="animation-delay:0.51s"/><circle class="ngdot" cx="810" cy="150" r="7" style="animation-delay:0.68s"/><circle class="ngdot ac" cx="1000" cy="90" r="7" style="animation-delay:0.85s"/><circle class="ngdot" cx="1150" cy="210" r="7" style="animation-delay:1.02s"/><circle class="ngdot" cx="150" cy="300" r="7" style="animation-delay:1.19s"/><circle class="ngdot ac" cx="350" cy="250" r="7" style="animation-delay:1.36s"/><circle class="ngdot hub" cx="540" cy="330" r="12" style="animation-delay:1.53s"/><circle class="ngdot hub" cx="730" cy="260" r="12" style="animation-delay:1.7s"/><circle class="ngdot ac" cx="930" cy="320" r="7" style="animation-delay:1.87s"/><circle class="ngdot" cx="1110" cy="380" r="7" style="animation-delay:2.04s"/><circle class="ngdot" cx="90" cy="440" r="7" style="animation-delay:2.21s"/><circle class="ngdot ac" cx="440" cy="440" r="7" style="animation-delay:2.38s"/><circle class="ngdot" cx="660" cy="430" r="7" style="animation-delay:2.55s"/><circle class="ngdot" cx="860" cy="440" r="7" style="animation-delay:2.72s"/><circle class="ngdot ac" cx="1030" cy="250" r="7" style="animation-delay:2.89s"/><circle class="ngdot" cx="250" cy="430" r="7" style="animation-delay:3.06s"/></svg>"""
NGBG = '<div class="ngbg" aria-hidden="true">' + NG_SVG + '</div>'
...
DEVP=[
 ...
 ("nvidia-dgx-spark","Device · Desktop supercomputer","NVIDIA DGX <span class='serif' style='color:var(--accent)'>Spark</span>",
  ...
  [("1,000<span class='o'>TFLOPS</span>","FP4 AI compute"),("128<span class='o'>GB</span>","coherent memory"),("200<span class='o'>B</span>","params, local")],
 ...
 ("qualcomm-qcs6490","Device · Power-efficient edge","Qualcomm <span class='serif' style='color:var(--accent)'>QCS6490</span>",
  ...
  [("12<span class='o'>TFLOPS</span>","Hexagon AI"),("5","concurrent cameras"),("Wi-Fi <span class='o'>6E</span>","FastConnect")],
  ("AI on a power budget",[("/hexagon","Hexagon AI at low watts","Up to 12 TFLOPS from the Hexagon processor with a fused tensor accelerator — vision, speech and sensor models on a budget that fits a fanless box or a battery.",["12 TFLOPS","Hexagon","low-power"]),
 ...
 ("amd-ryzen-ai-max-395","Device · Private AI server","AMD Ryzen AI <span class='serif' style='color:var(--accent)'>Max+ 395</span>",
  ...
  [("126<span class='o'>TFLOPS</span>","platform AI"),("128<span class='o'>GB</span>","LPDDR5X-8000"),("70<span class='o'>B</span>","models, local")],
  ("A private model server",[("/apu","16 Zen 5 + Radeon + XDNA 2","Sixteen Zen 5 CPU cores, a Radeon 8060S iGPU and a next-gen XDNA 2 NPU combine for 126 AI TFLOPS — CPU, GPU and NPU inference in one package.",["Zen 5","Radeon 8060S","XDNA 2"]),
...
DEV_ARCH={
 ...
 "nvidia-dgx-spark": platx("One coherent memory space",[
   ...
   "By the numbers",[("1,000<span class='o'>TFLOPS</span>","FP4 AI"),("128<span class='o'>GB</span>","unified memory"),("20","Arm Grace cores"),("4<span class='o'>TB</span>","NVMe storage")]),
 "qualcomm-qcs6490": platx("A heterogeneous compute engine",[
   ...
   ("/npu","Hexagon + Adreno","The Hexagon processor with a fused tensor accelerator and the Adreno GPU share inference and graphics — up to 12 TFLOPS.",["Hexagon","Adreno","12 TFLOPS"]),
   ...
   "By the numbers",[("12<span class='o'>TFLOPS</span>","Hexagon AI"),("5","concurrent cameras"),("Wi-Fi <span class='o'>6E</span>","FastConnect"),("6<span class='o'>nm</span>","process")]),
 "amd-ryzen-ai-max-395": platx("One package, three engines",[
   ...
   ("/gpu","Radeon 8060S + XDNA 2","The Radeon 8060S iGPU and XDNA 2 NPU share AI work for 126 TFLOPS across vision, language and agents.",["Radeon 8060S","XDNA 2","126 TFLOPS"]),
   ...
   "By the numbers",[("126<span class='o'>TFLOPS</span>","platform AI"),("128<span class='o'>GB</span>","LPDDR5X-8000"),("16<span class='o'>TB</span>","NVMe · PCIe 4.0"),("140<span class='o'>W</span>","TDP, ~32 dB")]),
}
